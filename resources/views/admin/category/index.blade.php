...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Product Category</li>
    </ol>
    <h6 class="font-weight-bolder mb-0">Product Category</h6>
</nav>
@endsection
...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('category_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="search" id="category_search" type="text" class="form-control" placeholder="Category Search">
        </div>
    </form>
</div>
@endsection
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info editBtn" value="{{$category->id}}">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive px-4">
                    ...
                    <form action="{{ url('admin_store_category') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="text" name="category_name" class="form-control" placeholder="Router">
                        </div>
...
<!--seen Modal-->
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="
            true">
    <div class="modal-dialog " role="document">
        <div class="modal-content  bg-white">
            <div class="text-center my-4">
                <h4 class="modal-title w-100 font-weight-bold text-dark">Category Edit
                </h4>
            </div>
                ...
                <div class="row">
                    <form action="{{ url('admin_update_category') }}" method="POST">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn bg-gradient-info w-100">Updated</button>
                        </div>
                    </form>
                </div>
            </div>
...
<ul class="navbar-nav">
    ...
    <li class="nav-item {{ Request::is('admin_category') ? 'active' : '' }}">
        <a class="nav-link active" href="{{url('admin_category')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
