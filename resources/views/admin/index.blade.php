        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Bills</p>
                            <h5 class="font-weight-bolder mb-0">
                                {{$invoice}}
                            </h5>
                        </div>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder mb-0">
                                {{ $user }}
                                <span class="text-danger text-sm font-weight-bolder">{{$people}}</span>
                            </h5>
                        </div>
                    </div>
                    <div class="col-4 text-end">
            ...
            <div class="row ">
                    ...
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <a style="text-decoration: none;" href="{{url('admin_combined_ledger')}}" target="_blank">
                                ...
                                <h2 class="text-white">{{ $ledger_customer }}
                                </h2>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="card l-bg-orange-dark">
                        <div class="card-statistic-3 p-4">
                            <div class="card-icon card-icon-large"><i class="fas fa-home"></i></div>
