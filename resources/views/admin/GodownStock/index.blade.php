...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('godown_stock_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="search" id="godown_stock_search" type="text" class="form-control" placeholder="Godown Search">
        </div>
    </form>
</div>
@endsection
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                ...
                <div style="display: flex; justify-content: space-between;" class="mb-2">
                    <h6>Godown Stock Product List</h6>

                    <a href="{{url('/admin_add_godown_stoke')}}" class=" btn btn-info btn-rounded">+ Godown</a>
                </div>
            </div>
