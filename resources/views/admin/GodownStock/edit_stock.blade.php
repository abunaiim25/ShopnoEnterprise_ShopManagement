...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Godown Stock</li>
    </ol>
    <h6 class="font-weight-bolder mb-0">Godown Stock</h6>
</nav>
@endsection
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div style="display: flex; justify-content: space-between;" class="mb-2">
                    ...
                    <a href="{{url('/admin_category')}}" class=" btn btn-primary btn-rounded">+ Category</a>
                </div>
            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_name" placeholder="Router22" value="{{$stock->product_name}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Brand:</label>
                                    <input class="form-control" type="text" name="brand" placeholder="TP-Link" value="{{$stock->brand}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_quantity" placeholder="product quantity" value="{{$stock->product_quantity}}" required>
                                </div>
                            </div>

                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Per Purchase Price:</label>
                                    <input class="form-control" type="text" name="per_cost_price" placeholder="700" value="{{$stock->per_cost_price}}" required>
                                </div>
                            </div>

                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Per Selling Price:</label>
                                    <input class="form-control" style="color: black" type="text" name="per_selling_price" placeholder="1000" value="{{$stock->per_selling_price}}" required>
                                </div>
                            </div>
                        </div>
...
<ul class="navbar-nav">
    ...
    <li class="nav-item {{ Request::is('admin_godown_stock') ? 'active' : '' }}">
        <a class="nav-link active" href="{{url('admin_godown_stock')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
