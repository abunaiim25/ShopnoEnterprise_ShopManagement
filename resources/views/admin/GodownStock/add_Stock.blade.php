        ...
        <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive px-4">
                    ...
                    <form action="{{ url('admin_store_godown_stock') }}" method="POST">
                        @csrf
                        <div class="row mt-3">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Product Name: </label>
                                    <input class="form-control" type="text" name="product_name" placeholder="Router22" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="product_quantity" placeholder="30" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="per_cost_price" placeholder="700" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" style="color: black" type="text" name="per_selling_price" placeholder="1000" required>
                                </div>
                            </div>
                        </div>
