...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('customer_ledger_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="ledger_search" id="customer_ledger_search" type="text" class="form-control" placeholder="Combined Ledger Search">
        </div>
    </form>
</div>
@endsection
        ...
        <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span class="text-secondary text-xs font-weight-bold">{{ $item->latest_balance ?? 0 }} TK</span>
                                </td>
                                ...
                                <td class="align-middle">
                                    ...
                                    <button type="button" class="btn btn-info btn-sm editbtn" value=" {{$item->id}}"> <i class="fa fa-pencil"></i> </button>
                    ...
                    @else
                    <h2 class="text-center p-5">Combined Ledger Not Available</h2>
                    @endif
                </div>
            </div>
        </div>
...
<ul class="navbar-nav">
    ...
    <li class="nav-item {{ Request::is('admin_combined_ledger') ? 'active' : '' }}">
        <a class="nav-link active" href="{{url('admin_combined_ledger')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
