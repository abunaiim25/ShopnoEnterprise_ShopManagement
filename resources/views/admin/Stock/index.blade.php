...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Shop Stock</li>
    </ol>
    <h6 class="font-weight-bolder mb-0">Shop Stock</h6>
</nav>
@endsection
...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('shop_stock_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="search" id="shop_stock_search" type="text" class="form-control" placeholder="Shop Search">
        </div>
    </form>
</div>
@endsection
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                ...
                <div style="display: flex; justify-content: space-between;" class="mb-2">
                    <h6>Shop Stock Product List</h6>

                    <a href="{{url('/admin_add_shop_stoke')}}" class=" btn btn-info btn-rounded">+ Shop</a>
                </div>
            </div>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Add Quantity</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="align-middle ">
                                    <span class="text-secondary text-xs font-weight-bold mx-3"><?php $i++ ?> {{ $i }}</span>
                                </td>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <span class="badge badge-sm bg-gradient-success">{{ $row->product_quantity }} In Stock</span>
                                </td>
                                @else
                                <td class="align-middle text-center text-sm">
                                ...
                                <td class="align-middle">
                                    <button type="button" class="btn btn-success btn-sm addQtybtn" value=" {{$row->id}}"> + Add Qty </button>
                                </td>

                                <td class="align-middle">
                                    <button type="button" class="btn btn-warning btn-sm seenBtn" value=" {{$row->id}}"> <i class="fas fa-eye"></i> </a> </button>

                                    <a href="{{ url('admin_shop_stock_edit/'. $row->id ) }}" class="btn btn-sm btn-info"> <i class="fa fa-pencil"></i> </a>
...
<ul class="navbar-nav">
    ...
    <li class="nav-item {{ Request::is('admin_shop_stock') ? 'active' : '' }}">
        <a class="nav-link active" href="{{url('admin_shop_stock')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
