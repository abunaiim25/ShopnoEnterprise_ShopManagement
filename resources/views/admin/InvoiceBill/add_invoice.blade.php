                        ...
                        <tbody>
                            <form action="{{ url('product_invoice_store') }}" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="warranty" type="text" class="form-control" placeholder="1" required>
                                    </td>
                                    <td>
                                        <input name="price" type="text" class="form-control" placeholder="1000" required>
                                    </td>
                                    <td>
                                        <input name="qty" type="text" class="form-control" placeholder="3" required>
                                    </td>
                                    <td>
                ...
                <div class="card-body px-0 pt-0 pb-2 mx-2">
                    <div class="table-responsive p-0">
                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="qty" type="text" class="form-control" placeholder="3" value="{{ $row->qty }} ({{ $row->price * $row->qty }} TK)" readonly>
                                    </td>
                                    <td>
                        ...
                        <div class="float-end mt-2">
                            <h1 class="badge bg-gradient-success">Total: {{ $subtotal }} TK</h1>
                        </div>
                        @else
                        @endif
                    </div>
                    ...
                    <div class="row mx-2">
                        <div class="col-lg-3 col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="previous_due" placeholder="0" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="subtotal" placeholder="selling amount" value="{{ $subtotal }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6">
                            <div class="form-group">
                                <label>Collecton:</label>
                                <input class="form-control" type="text" name="collecton" placeholder="0" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body px-0 pt-0 pb-2 mx-2">
                    ...
                    <div class="row  mx-2">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <label>Name:</label>
                                <input class="form-control" type="text" name="name" placeholder="Naiim" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <label>Person:</label>
                                <input class="form-control" type="text" name="person" placeholder="Rayhan" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <label>Address:</label>
                                <input class="form-control" type="text" name="address" placeholder="Dhaka, Bangladesh" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <label>Ref By:</label>
                                <input class="form-control" type="text" name="ref_by" placeholder="Saddam" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <label>Sold By:</label>
                                <input class="form-control" mtype="text" name="sold_by" placeholder="Srower" required>
                            </div>
                        </div>
