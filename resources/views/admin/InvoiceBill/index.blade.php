        ...
        <form action="{{ url('invoice_search') }}" method="GET" class="search">
            ...
            <div class="input-group">
                ...
                <input name="search" id="invoice_search" type="text" class="form-control"
                    placeholder="Invoice Bill Search">
            </div>
        </form>
    </div>
@endsection
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <div style="display: flex; justify-content: space-between;" class="mb-2">
                        ...
                        <div>
                            <a href="{{url('/admin_payment_status')}}" class=" btn bg-gradient-secondary btn-rounded">payment Status</a>
                              
                            <a href="{{ url('/admin_add_invoice') }}" class=" btn btn-info btn-rounded">+Invoice</a>
                                ...
                                <div style="display: flex; justify-content:center; align-items:center">
                                    <div class="mx-3" style="width:250px">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control bg-white text-dark p-2" type="date" width="295"
                                                name="fromDate" required placeholder="Previous Date">
                                        </div>
                                    </div>
                                    <div style="width:250px">
                                        <div class="form-group">
                                            <label for="input_from">To</label>
                                            <input class="form-control bg-white text-dark p-2" type="date" name="toDate"
                                                required placeholder="Last Date">
                                        </div>
                                    </div>
