...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('invoice_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="search" id="invoice_search" type="text" class="form-control" placeholder="Invoice Bill Search">
        </div>
    </form>
</div>
@endsection
                    ...
                    <div class="row justify-content-center">
                        <form action="{{ url('date_from_to_search') }}" method="POST" class="row">
                            ...
                            <div style="display: flex; justify-content:center; align-items:center">
                                ...
                                <button type="submit" class="btn btn-success mt-4 mx-2" title="Search">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Date (M/D/Y)</th>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        <p class="mb-1 pt-2 text-bold">Total Selling Amount</p>
                                ...
                                <div class="col-lg-6 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-gradient-primary border-radius-lg h-100">
                                        <img src="{{ asset('admin') }}/assets/img/card.jpg" class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                                    </div>
                                </div>
                            </div>
                        </div>
