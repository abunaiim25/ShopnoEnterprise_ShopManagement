...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('admins_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="search" id="search_admin" type="text" class="form-control" placeholder="People Search">
        </div>
    </form>
</div>
@endsection
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Create User</th>
                            </tr>
                        </thead>
                        <tbody>
