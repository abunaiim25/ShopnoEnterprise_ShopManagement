...
<div class="ms-md-auto pe-md-3 d-flex align-items-center">
    <form action="{{url('contact_search')}}" method="GET" class="search">
        {{csrf_field()}}
        <div class="input-group">
            <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
            <input name="search" id="contact_search" type="text" class="form-control" placeholder="Contact Search">
        </div>
    </form>
</div>
@endsection
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    {{ Str::limit(strip_tags($row->message), 20)  }}
                                ...
                                <td class="align-middle">
                                    ...
                                    <a class="btn btn-info btn-sm" href="{{ url('contact_seen_admin', $row->id) }}">
                                        <i class="fas fa-thumbs-up"></i> </a>
                                    @else
                                    <span class="badge badge-sm bg-gradient-success">Seen</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
...
<ul class="navbar-nav">
    ...
    <li class="nav-item {{ Request::is('admin_contact') ? 'active' : '' }}">
        <a class="nav-link active" href="{{url('admin_contact')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 256">
