    ...
    <div class="copyright mt-4">
        <div class="row container mx-auto">
            ...
            <div class="col-lg-6  col-12">
                <a href="{{$front->footer_social_fb}}" target="_blank"><i class="fab fa-facebook-f"></i></a>
                <a href="{{$front->footer_social_twitter}}" target="_blank"><i class="fab fa-twitter"></i></a>
                <a href="{{$front->footer_social_linkedin}}" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                <a href="{{$front->footer_social_insta}}" target="_blank"><i class="fab fa-instagram"></i></a>
            </div>
