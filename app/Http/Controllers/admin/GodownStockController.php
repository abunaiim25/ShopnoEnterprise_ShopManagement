...
{ 
    ...
    public function store(Request $request)
    {
        ...
        $stoke->save();
        return Redirect('admin_godown_stock')->with('status_swal', 'Product Added Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $stock->save();
        return Redirect('admin_godown_stock')->with('status_swal', 'Product Updated Successfully');
    }
