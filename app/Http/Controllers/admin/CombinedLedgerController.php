...
class CombinedLedgerController extends Controller
{
    ...
    public function customer_ledger_store(Request $request)
    {
        ...
        return Redirect()->back()->with('status_swal', 'Combined Ledger Created');
    }
    ...
    public function customer_ledger_update(Request $request)
    {
        ...
        return Redirect()->back()->with('status_swal', 'Customer Information Updated');
    }
    ...
    public function customer_ledger_debit(Request $request, $id)
    {
        ...
        return Redirect()->back()->with('status_swal', 'Debit Successfull');
    }
    ...
    public function customer_ledger_credit(Request $request, $id)
    {
        ...
        return Redirect()->back()->with('status_swal', 'Credit Successfull');
    }
    ...
    public function customer_ledger_delete($id)
    {
        ...
        return Redirect()->back()->with('status_swal', 'Customer & Ledger Deleted Successfully');
    }
