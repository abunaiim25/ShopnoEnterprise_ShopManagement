...
class EmailController extends Controller
{
    ...
    public function send_email(Request $request, $id)
    {
        ...
        return redirect('/home')->with('status_swal', 'Email Send Successfully');
    }
    ...
    public function contact_send_email(Request $request, $id)
    {
        ...
        Notification::send($data, new SendEmailNotification($details));
        return redirect('admin_contact')->with('status_swal', 'Email Send Successfully');
    }
        ...
        public function payment_send_email(Request $request, $id)
        {
            ...
            Notification::send($data, new SendEmailNotification($details));
            return redirect('admin_payment_online')->with('status_swal', 'Email Send Successfully');
        }
