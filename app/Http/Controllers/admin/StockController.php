...
class StockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $stoke->save();
        return Redirect('admin_shop_stock')->with('status_swal', 'Product Added Successfully');
    }
    ...
    public function addQty_stock_update(Request $request)
    {
        ...
        return Redirect()->back()->with('status_swal', 'Product Quantity Updated');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $stock->save();
        return Redirect('admin_shop_stock')->with('status_swal', 'Product Updated Successfully');
    }
